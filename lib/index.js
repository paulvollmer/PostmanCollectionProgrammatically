...
PostmanCollection.prototype.isMethodValid = function(method) {
  if(method) {
    switch(method) {
      ...
      case METHOD.COPY:
      case METHOD.COPY.toLowerCase():
      case METHOD.HEAD:
      case METHOD.HEAD.toLowerCase():
      case METHOD.OPTIONS:
      case METHOD.OPTIONS.toLowerCase():
      case METHOD.LINK:
      case METHOD.LINK.toLowerCase():
      case METHOD.UNLINK:
      case METHOD.UNLINK.toLowerCase():
      case METHOD.PURGE:
      case METHOD.PURGE.toLowerCase():
      case METHOD.LOCK:
      case METHOD.LOCK.toLowerCase():
      case METHOD.UNLOCK:
      case METHOD.UNLOCK.toLowerCase():
      case METHOD.PROPFIND:
      case METHOD.PROPFIND.toLowerCase():
        return true;
      default:
        return false;
    }
